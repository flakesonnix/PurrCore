{
  description = "PurrCore — shared core for Paper & Spigot — DB + I18n";
      ...
      in
      {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo "PurrCore — java $(java -version 2>&1 | head -n1) | gradle $(gradle --version | grep Gradle)"
            echo "  gradle shadowJar        → build/libs/purrcore-1.0.0.jar (Kotlin-JVM, Paper API)"
